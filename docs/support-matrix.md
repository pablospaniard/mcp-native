...
| React Native      | peer `>=0.86.0 <1`; exact boundaries `0.86.0` and `0.87.1`                                        | both boundaries typecheck, bundle, and natively build                             |
...
| Community JSC     | `@react-native-community/javascriptcore@0.2.0` in the JSC fixture                                 | Android runtime factory and iOS ReactJSC factory                                  |
