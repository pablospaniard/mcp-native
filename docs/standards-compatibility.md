...
lane, and a feature-scoped A2UI v1.0 Candidate profile. See the [MCP protocol support
policy](protocol-support.md) and [A2UI conformance profile](a2ui-v1-conformance.md) for the exact
...
This package provides HTML classification and deny-by-default document-policy primitives with
explicit inline-document opt-in, HTTP(S)-only remote loads, and required origin allowlists.
