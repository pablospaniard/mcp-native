...
These mappings have automated host-boundary coverage plus recorded Android 17 TalkBack and iOS 26.5
XCUITest results for the historical pinned fixture. The [Expo Go integration PoC
policy](../../docs/native-accessibility-testing.md) defines the shared surface and the independent
app-per-library approach. The [automated robustness gates](../../docs/a2ui-v1-performance.md) define
...
non-blocking app-level compatibility work. Historical generated-host results remain scoped to the
exact environments in which they were recorded.
